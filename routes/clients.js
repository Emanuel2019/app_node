...
route.post('/',(req, res, next) => {
    mysql.getConnection((error, conn) => {
        conn.query(
            ...
            [req.body.reference, req.body.name, req.body.address, req.body.country, req.body.city, req.body.phone1, req.body.phone2, req.body.email1, req.body.email2, req.body.Active, req.body.user_id],
