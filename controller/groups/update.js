...
const update = async (req, res, next) => {
    ...
    try {
        ...
        const query =  "UPDATE \`groups\` SET name=?,description=?,user_id=? WHERE id=?";
        const result = await mysql.execute(query,  [req.body.name, req.body.description, req.body.user_id, id]);
